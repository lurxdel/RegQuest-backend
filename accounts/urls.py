...
from .views import UserViewSet, StudentInfoViewSet, StaffInfoViewSet, RegisterView, admin_demo, staff_demo, student_demo, logout_view, CustomTokenObtainPairView
